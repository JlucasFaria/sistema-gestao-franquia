...
/// <summary>
/// Dados para cadastro de um item do catálogo. O item nasce ativo.
/// </summary>
public class CriarProdutoRequest
{
    ...
    /// <summary>
    /// Indica que o item é um serviço, e não um produto físico. Não pode ser alterado depois
    /// do cadastro: serviços não movimentam estoque.
    /// </summary>
